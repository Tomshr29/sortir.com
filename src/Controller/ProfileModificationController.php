...
class ProfileModificationController extends AbstractController
{
    ...
    public function modifie(int $id,UserRepository $userRepository,Request $request, EntityManagerInterface $entityManager): Response
    {
    ...
    #[Route('profil/edition-mot-de-passe/{id}', name: 'edit_password')]
